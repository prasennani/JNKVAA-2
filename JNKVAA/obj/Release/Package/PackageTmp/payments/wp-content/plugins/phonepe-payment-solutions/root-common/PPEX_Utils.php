...
if (!class_exists('PPEX_Utils')) {
  class PPEX_Utils {
    ...
    public static function get_payment_request_script($environment) {
      if ($environment == PPEX_Constants::PRODUCTION) {
        return PPEX_Constants::PAYMENTREQUEST_PROD_SCRIPT;
      }
      if ($environment == PPEX_Constants::UAT) {
        return PPEX_Constants::PAYMENTREQUEST_UAT_SCRIPT;
      }
      return PPEX_Constants::PAYMENTREQUEST_STAGE_SCRIPT;
    }
